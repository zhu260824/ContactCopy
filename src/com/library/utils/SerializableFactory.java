...
public class SerializableFactory {
	public final static String MPLUS="zhulin";

	/**
	 * 存数据
	 * */
	public static  void SaveData(String name,String data){
		SharedPreferences sp = ZLApplication.getInstance().getSharedPreferences(MPLUS, Context.MODE_PRIVATE);
	...
	public static void DetailsData(String name,int type){
		SharedPreferences settings = ZLApplication.getInstance().getSharedPreferences(MPLUS, Context.MODE_PRIVATE);
		//获得可编辑对象
	...
	public static void sharedPreferencesSave(String name,String key,String value){
			...
			SharedPreferences settings = ZLApplication.getInstance().getSharedPreferences(name, Context.MODE_PRIVATE);
			//获得可编辑对象
			SharedPreferences.Editor editor = settings.edit();
